          ...
          {location.pathname === "/AdminDashboard" && (
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                <div
                  className="p-4 md:p-6 rounded-xl shadow-lg bg-[#FFD700] text-[#000000]"
                  style={orbitronStyle}
                >
                ...
                >
                  <h2 className="text-lg font-medium mb-1 md:mb-2">
                    Usage Activity
                  </h2>
              ...
              <div className="p-4 md:p-6 rounded-xl shadow-lg bg-[#F5F5F5]">
                <h2
                  className="text-lg md:text-xl font-semibold mb-2 md:mb-4 text-[#000000]"
                  style={orbitronStyle}
                >
                  Weekly Usage Chart
                </h2>
